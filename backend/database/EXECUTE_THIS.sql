-- =====================================================
-- INSTRUÇÕES: Execute este SQL no phpMyAdmin
-- =====================================================
-- 1. Acesse phpMyAdmin do AlwaysData
-- 2. Selecione o banco: isabellamuller_sabor-local
-- 3. Vá na aba SQL
-- 4. Cole TODO este código abaixo
-- 5. Clique em "Go" ou "Executar"
-- =====================================================

-- Primeiro, atualizar os restaurantes existentes com imagens
...
-- Agora, inserir mais restaurantes com variedade de culinárias
...
-- =====================================================
-- PRONTO! Agora você tem 12 restaurantes no banco!
-- Recarregue a página do frontend para ver as mudanças
-- =====================================================
